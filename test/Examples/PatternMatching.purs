module Test.Examples.PatternMatching where

import Examples.PatternMatching (gcdV2, Person, factorial, binomial, pascal, sameCity, fromSingleton, gcd, fromString, toString, isEmpty, takeFive, showPerson, showPersonV2, unknownPerson, livesInLA, sortPair, lzs, partialFunction, current, calculateWattage, Volt(..), Watt(..), Amp(..))
-- 隐藏导出
...
import Examples.Picture (Picture, Shape(..), origin, getCenter, circleAtOrigin, doubleScaleAndCenter, shapeText, area, shapeBounds)
...
patternMatchingMain :: Effect Unit
patternMatchingMain =
  runTest do
    runChapterExamples
